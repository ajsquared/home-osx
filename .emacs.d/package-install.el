...
(defvar ajsquared-packages
  '(maxframe bar-cursor auctex auto-complete autopair company dropdown-list magit markdown-mode sublime-themes popup powerline python-mode rainbow-delimiters yasnippet scala-mode2)
